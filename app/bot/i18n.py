...
TEXTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "price_free": "Free",
        "price_from_amount": "from {amount}",
        "price_mode_exact": "Exact price",
        "price_mode_from": "From price",
        "price_settings_title": "💰 Price",
        "price_current_label": "Current price: {price}",
        "price_type_label": "Price type:",
        "price_change_amount": "✏️ Change amount",
        "price_set_exact": "🔢 Exact price",
        "price_set_from": "📈 From price",
        "price_back_to_service": "🔙 Back to service",
        "price_mode_updated": "Price type updated.",
        ...
        "booking_already_confirmed": "This booking is already confirmed.",
        "booking_cannot_confirm_cancelled": "Cannot confirm a cancelled booking.",
    ...
    "ru": {
        ...
        "price_from_amount": "от {amount}",
        "price_mode_exact": "Точная цена",
        "price_mode_from": "Цена от",
        "price_settings_title": "💰 Цена",
        "price_current_label": "Текущая цена: {price}",
        "price_type_label": "Тип цены:",
        "price_change_amount": "✏️ Изменить сумму",
        "price_set_exact": "🔢 Точная цена",
        "price_set_from": "📈 Цена от",
        "price_back_to_service": "🔙 Назад к услуге",
        "price_mode_updated": "Тип цены обновлён.",
        ...
        "booking_already_confirmed": "Эта запись уже подтверждена.",
        "booking_cannot_confirm_cancelled": "Нельзя подтвердить отменённую запись.",
